    ...
    >
      <Card.Header padded>
        <View style={styles.cardHeader}>
          ...
          <H3 theme={'alt2'} 
          color={'$black050'}
          // color={colorscheme=='dark'?'skyblue':'$colorPress'} 
          size={'$8'}>
            {props.category}
          </H3>
        </View>
        ...
        {/* <View style={styles.paragraphContainer}>
          <Paragraph style={[styles.paragraph, styles.next30Days]}>
            Next 30 days: <Text style={styles.highlightedText}>2</Text>
          </Paragraph>
          <Paragraph style={[styles.paragraph, styles.next30To60Days]}>
            Next 30 - 60 days: <Text style={styles.highlightedText}>3</Text>
          </Paragraph>
          <Paragraph style={[styles.paragraph, styles.next60To90Days, {color:colorscheme=='dark'?'#CCE3F3':'#004684'}]}>
            Next 60 - 90 days: <Text style={styles.highlightedText}>0</Text>
          </Paragraph>
        </View> */}
      </Card.Header>
...
<Svg height="100" width="300" style={{ marginVertical:70}}>
  <Line
    x1="10"
    y1="35"
    x2="290"
    y2="35"
    opacity={0.7}
    stroke={colorscheme === 'light' ? '#004684' : '#B0BEC5'}
    strokeWidth="2"
  />
  
  <Circle cx="60" cy="35" r="6" fill="#FFCCBC" />
  <SVGText
    x="40"
    y="20" 
    fontSize="20"
    fill={colorscheme === 'light' ? '#FF5722' : '#FFAB91'}
    fontWeight="bold"
  >
    2 
  </SVGText>
  ...
  <Circle cx="150" cy="35" r="6" fill="#C8E6C9" />
  <SVGText
    x="130"
    y="20" 
    fontSize="20"
    fill={colorscheme === 'light' ? '#4CAF50' : '#81C784'}
    fontWeight="bold"
  >
    3 
  </SVGText>
  ...
  <Circle cx="240" cy="35" r="6" fill="#E0F7FA" />
  <SVGText
    x="220"
    y="20" 
    fontSize="20"
    fill={colorscheme === 'light' ? '#03A9F4' : '#81D4FA'}
    fontWeight="bold"
  >
    0 
  </SVGText>
 ...
 {props.category=='Agreements' && <SVGText
    x="10"
    y="80"
    fontSize="13"
    fill={colorscheme === 'light' ? '#FF5722' : '#FFAB91'}
  ...
  {props.category=='Agreements' && <SVGText
    ...
    y="83"
    fontSize="18"
    fill={colorscheme === 'light' ? '#FF5722' : 'yellow'}
    fontWeight="bold"
  >
    9 
  </SVGText>}
